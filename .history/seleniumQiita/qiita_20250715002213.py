...
#     cobElem = wait.until(EC.presence_of_element_located((By.CLASS_NAME, "style-1snuvpu")))
#     cobCnt = cobElem.text
# except Exception as e:
#     cobCnt = "取得失敗"
#     print("Contributions数の取得に失敗しました:", e)

# Contributions数のメッセージボックス表示
root = tkinter.Tk()
root.withdraw()
messagebox.showinfo("selenium sample, 本日も張り切ってアウトプットしていこう！")
